...
class NetworkUtils:
    ...
    @classmethod
    def __test_conflict(cls, network: ipaddress.IPv4Network) -> bool:
    ...
    @classmethod
    def get_next_available_range(cls, large_range: str, network_size: int):
